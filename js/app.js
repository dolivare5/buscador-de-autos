...
function eventListener(){
    ...
    btnResetear.addEventListener('submit', resetearFormulario);
    // Enviar email
...
function mostrarErrorFormulario(e) {
...
function enviarEmail(e) {
    ...
    setTimeout( () =>{
        ...
        parrafo.classList.add('text-center', 'mg-10', 'p-2', 'bg-green-500', 'text-white', 'font-bold', 'uppercase')
        // Inserta el parrafo antes del spinner
        formulario.insertBefore(parrafo, spiner);
        setTimeout( () => {
            parrafo.remove(); // Elimina el mensaje de éxito
            btnEnviar.style.display = 'flex';
            btnResetear.style.display = 'flex';
            resetearFormulario();
        }, 5000)
    }, 3000)
